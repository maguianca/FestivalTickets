...
public class SpectacoleViewController extends Controller implements Observer {
    ...
    private void loadAllSpectacole() {
        try {
            System.out.println("Incepem loadAllSpectacole");
            ...
            System.out.println("Timp incarcare spectacole (initial): " + (t2 - t1) + " ms");
    ...
    public void updatedSpectacol(Spectacol s) {
        System.out.println("Platform.runLater e pornit");
        Platform.runLater(() -> {
            long t1 = System.currentTimeMillis();
            ...
            long t2 = System.currentTimeMillis();
            System.out.println(" Timp actualizare UI (1 spectacol): " + (t2 - t1) + " ms");
        });
    }
}
